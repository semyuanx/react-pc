...
// 优惠活动主dom
var ActivityDOM = React.createClass({
    render(){
        return (
            <div className="clothing">
                <div className="subBanner ">
                    <div className="ban_item">
                        <img src={require('../assets/img/activity/subBanner6.jpg')} alt="优惠活动" height="502" />
                    </div>
                </div>
                <div className="privilege_desc w1200">
                    <div className="preDes_left">
                        ...
                        <div style={{marginBottom:'10px'}}>
                            <img src={require('../assets/img/activity/rule-title.png')} alt="优惠活动" />
                        </div>
