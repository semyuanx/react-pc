...
require('../assets/css/inmail/style.css')

// 站内信列表
var InMailTable = React.createClass({
    render() {
        return (
...
// 站内信详情
var InMailDetails = React.createClass({
    render() {
        return (
...
// 站内信DOM 
var InMailDOM = React.createClass({
    render() {
        return (
