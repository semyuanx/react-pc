                        ...
                        <ul className="down_icon fr">
                            <li className="pc_down">
                                <a target="_blank" href="http://cdn.win88.co/setupglx.exe">
                                    <img alt="GPI" style={{ width: '100%' }} src={require('../../assets/img/egame/xiazaipc.png')} />
                                </a>
                            </li>
                            <li>
                                <div className="ptPhoneDown">
                                    <img alt="GPI" src={require('../../assets/img/egame/pcDownright.png')} width="40px" />
                                </div>
                                <p className="phoneCode">
                                    <img alt="GPI" style={{ width: '100%' }} src={require('../../assets/img/egame/pt_phoneCode.png')} />
                                </p>
                            </li>
                        </ul>
                    </div>
