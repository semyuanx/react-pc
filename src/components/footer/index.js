        ...
        return (
            <div>
                <div className="b_wechat w1200">
                    <ul className="b_wechatItem">
                        <li className="b_weAdd">
                            ...
                            <span>CSTBET</span>
                            <i></i>
                            <b><img alt="联系我们" src={require('../../assets/img/footer/icon_wechat_c_qr.png')}/></b>
                        </li>
                        <li className="b_weAdd">
                            <p>微信公众号</p>
                            <span>TBET_CASINO</span>
                            <i></i>
                            <b><img  alt="联系我们" src={require('../../assets/img/footer/icon_wechat_p_qr.png')} width="86" /></b>
                        </li>
                        <li className="b_weNum">
                            <p>官方微博</p>
                            <span>T博娱乐TBET</span>
                            <i></i>
                            <b><img alt="联系我们" src={require('../../assets/img/footer/icon_weibo_qr.png')} /></b>
                        </li>
                ...
                <div className="footer">
                    <div className="footer_icon w1200"><img alt="联系我们" src={require('../../assets/img/footer/footer_icon.png')} /></div>
